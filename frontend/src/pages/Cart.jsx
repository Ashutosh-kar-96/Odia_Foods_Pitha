    ...
    return (
      <section className="container-page py-20 text-center">
        ...
        <p className="mt-3 text-ink/70">
          Add your favorite Pithas and Panas before checkout.
        </p>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
        <div className="grid gap-4">
          {items.map((item, index) => (
            <div
              ...
              className="grid gap-4 rounded-lg border border-temple/10 bg-white p-4 shadow-sm sm:grid-cols-[120px_1fr_auto]"
            >
              <img
                src={item.image_url}
                alt={item.name}
              ...
              <div className="flex items-center gap-3 self-center">
                ...
                <button
                  className="rounded-md border p-2 text-sindoor"
                  onClick={async () => {
        ...
        <aside className="h-fit rounded-lg border border-temple/10 bg-white p-6 shadow-soft">
          ...
          <div className="mt-5 space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span>Delivery</span>
              <span>{total > 499 ? "Free" : money(49)}</span>
            </div>
          </div>
